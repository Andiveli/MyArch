...
Singleton {
    ...
    darkColors: QtObject {
        id: darkColors
        property color bgPanelBody: '#000000'
        property color bgPanelSeparator: "#191919"
        property color bg0: "#1C1C1C"
        property color bg0Border: "#f700ff"
        property color bg1Base: '#ff029e'
        property color bg1: '#2C2C2C'
        property color bg1Hover: "#292929"
        property color bg1Active: '#ba5663'
        property color bg1Border: '#bebebe'
        property color bg2Base: "#f53c3c"
