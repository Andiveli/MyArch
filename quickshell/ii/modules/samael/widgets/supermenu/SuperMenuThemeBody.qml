    ...
    readonly property var actions: [
        ...
        { label: "Random wallpaper", run: () => {
            ...
            Quickshell.execDetached(["bash", "-c",
                "d=\"/home/samael/Pictures/wallpapers\"; mapfile -t a < <(find -L \"$d\" -type f \\( -iname '*.jpg' -o -iname '*.jpeg' -o -iname '*.png' -o -iname '*.webp' \\)); [[ ${#a[@]} -gt 0 ]] && bash /home/samael/.config/quickshell/ii/scripts/wallpaper/samael-wallpaper.sh \"${a[$RANDOM % ${#a[@]}]}\""
            ])
        }},
    ]
