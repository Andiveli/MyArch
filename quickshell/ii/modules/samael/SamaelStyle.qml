...
Singleton {
    ...
    // Waybar 97% se ve más grande en Qt; un poco menos en QS
    ...
    // font-size: 97% (relativo al tamaño del sistema, como Waybar)
    readonly property int fontPixelSize: Math.max(9, Math.round(_gtkBaseFontPx * waybarFontSizePercent))

    // OpenType features (waybar font-feature-settings) — Qt 6.5+
    ...
    readonly property color textColor: WallustColors.moduleText
        /** Drop menus, sidebar, super menu, island, calendar — darker than bar modules */
