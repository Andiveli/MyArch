...
TextField {
    ...
    readonly property color fieldForeground: {
        const _g = WallustColors.paletteGeneration
        return WallustColors.foreground
    }

    color: fieldForeground
    placeholderTextColor: Qt.rgba(fieldForeground.r, fieldForeground.g, fieldForeground.b, 0.55)
