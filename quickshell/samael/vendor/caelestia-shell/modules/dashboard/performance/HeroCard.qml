...
StyledRect {
    ...
    implicitWidth: compactLayout ? Math.max(0, parent ? parent.width : 0) : Tokens.sizes.dashboard.perfHeroCardWidth
    ...
    ColumnLayout {
        ...
        anchors.rightMargin: compactLayout ? Tokens.spacing.small : Tokens.spacing.large
        spacing: Tokens.spacing.extraSmall
        clip: compactLayout
