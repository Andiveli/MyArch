...
ColumnLayout {
    ...
    ClockText {
        id: timeTextTop
        text: clockColumn.isVertical ? SamaelDateTime.time.split(":")[0].padStart(2, "0") : SamaelDateTime.time
    ...
    Loader {
        ...
        sourceComponent: ClockText {
            id: timeTextBottom
            text: SamaelDateTime.time.split(":")[1].split(" ")[0].padStart(2, "0")
            color: clockColumn.colText
