...
Item {
    ...
    readonly property list<string> clockNumbers: SamaelDateTime.time.split(/[: ]/)
    readonly property int clockHour: parseInt(clockNumbers[0]) % 12
    readonly property int clockMinute: SamaelDateTime.clock.minutes
    readonly property int clockSecond: SamaelDateTime.clock.seconds
