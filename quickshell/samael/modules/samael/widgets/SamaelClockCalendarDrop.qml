        ...
        sourceComponent: PanelWindow {
            ...
            margins.top: GlobalStates.samaelClockDropTop > 0
                ...
                margins.left: {
                    ...
                    const cx = pinnedCenterX > 0
                        ? pinnedCenterX
                        : (GlobalStates.samaelClockDropCenterX > 0
            ...
            mask: Region { item: dropRoot }
                ...
                Component.onCompleted: {
                    pinnedCenterX = GlobalStates.samaelClockDropCenterX > 0
                        ? GlobalStates.samaelClockDropCenterX
                        : ((targetScreenObj?.width ?? 1920) / 2)
                    Qt.callLater(() => { dropRoot.offsetScale = 0 })
                }
