...
// II NotificationGroup logic (timeouts on hover, drag dismiss, expand) + Wallust look.
MouseArea {
    id: root
    ...
    Rectangle {
        ...
        width: parent.width
        color: popup ? WallustColors.moduleBackground : Appearance.colors.colLayer2
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Item {
                    id: topRow
                    Layout.fillWidth: true
                    property real fontSize: SamaelStyle.fontPixelSize - 1
                    property bool showAppName: root.multipleNotifications
                    implicitHeight: Math.max(topTextRow.implicitHeight, expandHint.implicitHeight)
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.pixelSize: topRow.showAppName ? topRow.fontSize : SamaelStyle.fontPixelSize
                            font.family: SamaelStyle.fontFamily
                            color: topRow.showAppName ? WallustColors.sapphire : WallustColors.moduleText
                        }
                        Text {
                    ...
                    Text {
                        ...
                        anchors.right: parent.right
                        anchors.verticalCenter: parent.verticalCenter
                        text: (root.expanded ? "▾ " : "▸ ") + root.notificationCount
                        font.family: SamaelStyle.fontFamily
                        font.pixelSize: topRow.fontSize
