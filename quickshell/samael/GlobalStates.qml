...
Singleton {
    ...
    /** True while close attach runs (panel slide up + dock narrow) before Loader unloads */
    property bool samaelMediaClosing: false
    /** 0 = docked flush to bar; 1 = panel tucked under bar (Caelestia-style attach anim) */
    property real samaelMediaAttach: 1.0
    // Performance drop (Caelestia Performance + top processes / audio)
    property bool samaelPerformanceDropOpen: false
    property bool samaelPerformanceClosing: false
    property string samaelPerformanceScreenName: ""
    property real samaelPerformanceCenterX: 0
    property real samaelPerformanceDockTop: 0
    property real samaelPerformanceDockLeft: 0
    property real samaelPerformanceDockWidth: 0
